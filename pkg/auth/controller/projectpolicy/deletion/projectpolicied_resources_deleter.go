...
// ProjectPoliciedResourcesDeleterInterface to delete a policy with all resources in
// it.
type ProjectPoliciedResourcesDeleterInterface interface {
	Delete(policyName string) error
}

// NewProjectPoliciedResourcesDeleter to create the projectPoliciedResourcesDeleter that
// implement the ProjectPoliciedResourcesDeleterInterface by given client and
// configure.
func NewProjectPoliciedResourcesDeleter(policyClient v1clientset.ProjectPolicyInterface,
	authClient v1clientset.AuthV1Interface,
	enforcer *casbin.SyncedEnforcer,
	finalizerToken v1.FinalizerName,
	deleteProjectPolicyWhenDone bool) ProjectPoliciedResourcesDeleterInterface {
	d := &projectPoliciedResourcesDeleter{
...
var _ ProjectPoliciedResourcesDeleterInterface = &projectPoliciedResourcesDeleter{}

// projectPoliciedResourcesDeleter is used to delete all resources in a given policy.
type projectPoliciedResourcesDeleter struct {
	// Client to manipulate the policy.
	projectPolicyClient v1clientset.ProjectPolicyInterface
	authClient          v1clientset.AuthV1Interface
...
func (d *projectPoliciedResourcesDeleter) Delete(policyName string) error {
...
func (d *projectPoliciedResourcesDeleter) deletePolicy(policy *v1.ProjectPolicy) error {
...
type updateProjectPolicyFunc func(policy *v1.ProjectPolicy) (*v1.ProjectPolicy, error)

// retryOnConflictError retries the specified fn if there was a conflict error
// it will return an error if the UID for an object changes across retry operations.
// TODO RetryOnConflict should be a generic concept in client code
func (d *projectPoliciedResourcesDeleter) retryOnConflictError(policy *v1.ProjectPolicy, fn updateProjectPolicyFunc) (result *v1.ProjectPolicy, err error) {
	latestPolicy := policy
	for {
...
func (d *projectPoliciedResourcesDeleter) updatePolicyStatusFunc(policy *v1.ProjectPolicy) (*v1.ProjectPolicy, error) {
	if policy.DeletionTimestamp.IsZero() || policy.Status.Phase == v1.BindingTerminating {
		return policy, nil
	}
	newPolicy := v1.ProjectPolicy{}
...
func finalized(policy *v1.ProjectPolicy) bool {
	return len(policy.Spec.Finalizers) == 0
}

// finalizeProjectPolicy removes the specified finalizerToken and finalizes the policy
func (d *projectPoliciedResourcesDeleter) finalizeProjectPolicy(policy *v1.ProjectPolicy) (*v1.ProjectPolicy, error) {
	policyFinalize := v1.ProjectPolicy{}
...
type deleteResourceFunc func(deleter *projectPoliciedResourcesDeleter, policy *v1.ProjectPolicy) error
...
func (d *projectPoliciedResourcesDeleter) deleteAllContent(policy *v1.ProjectPolicy) error {
...
func deleteRelatedRules(deleter *projectPoliciedResourcesDeleter, policy *v1.ProjectPolicy) error {
